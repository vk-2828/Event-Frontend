...
// import React, { useState, useRef, useEffect } from "react";
// // I've created an SVG for the chat icon directly in the component so you don't need a separate file.

// const API_URL = "http://127.0.0.1:8000/ai/ask";

// const Chatbot = () => {
//   const [isOpen, setIsOpen] = useState(false);
//   const [messages, setMessages] = useState([{ sender: "ai", text: "Hello! How can I help you with our events today?" }]);
//   const [inputValue, setInputValue] = useState("");
//   const [isLoading, setIsLoading] = useState(false);
//   const messagesEndRef = useRef(null);
...
//           "Content-Type": "application/json",
//           // --- ERROR FIXED HERE ---
//           // Added the required space after "Bearer"
...
//         throw new Error(errData.detail || "Error occurred");
//       }
...
//   return (
//     <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
//       {/* --- Chat Window (Styled with the app theme) --- */}
//       {/* --- ERROR FIXED HERE: Correctly used template literals for dynamic classes --- */}
