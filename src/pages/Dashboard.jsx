...
//without cancel button running code 
...
//     // --- FEATURE ADDED HERE ---
//     // This line smoothly scrolls the page to the top.
//     window.scrollTo({ top: 0, behavior: 'smooth' });
//   };
...
//   if (loading)
//     return <div className="min-h-screen bg-slate-50 flex items-center justify-center text-xl">Loading events...</div>;
